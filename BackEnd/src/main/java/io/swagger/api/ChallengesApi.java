...
public interface ChallengesApi {
    ...
    @ApiOperation(value = "", nickname = "getChallenges", notes = "", response = SmallInfo.class, responseContainer = "List", tags={ "challenge", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<List<SmallInfo>> getChallenges(@ApiParam(value = "" ) @RequestHeader(value="Auth", required=false) String auth
);
