...
@Api(value = "challenge_post_facebook", description = "the challenge_post_facebook API")
public interface ChallengePostFacebookApi {

    @ApiOperation(value = "", nickname = "postChallengeToFacebook", notes = "", tags={ "challenge", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 401, message = "Authentication information is missing or invalid") })
    @RequestMapping(value = "/challenge_post_facebook",
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<Void> postChallengeToFacebook(@ApiParam(value = "" ,required=true )  @Valid @RequestBody ChallengeInfo body
