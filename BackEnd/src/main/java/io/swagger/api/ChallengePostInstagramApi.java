...
@Api(value = "challenge_post_instagram", description = "the challenge_post_instagram API")
public interface ChallengePostInstagramApi {

    @ApiOperation(value = "", nickname = "postChallengeToInstagram", notes = "", tags={ "challenge", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 401, message = "Authentication information is missing or invalid") })
    @RequestMapping(value = "/challenge_post_instagram",
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<Void> postChallengeToInstagram(@ApiParam(value = "" ,required=true )  @Valid @RequestBody ChallengeInfo body
