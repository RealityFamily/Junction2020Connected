...
@Api(value = "patterns", description = "the patterns API")
public interface PatternsApi {

    @ApiOperation(value = "", nickname = "getPatterns", notes = "", response = Pattern.class, responseContainer = "List", tags={ "pattern", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = Pattern.class, responseContainer = "List"),
        @ApiResponse(code = 401, message = "Authentication information is missing or invalid") })
    @RequestMapping(value = "/patterns",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Pattern>> getPatterns(@ApiParam(value = "" ) @RequestHeader(value="Auth", required=false) String auth
);
