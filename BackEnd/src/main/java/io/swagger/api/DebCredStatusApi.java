...
@Api(value = "deb_cred_status", description = "the deb_cred_status API")
public interface DebCredStatusApi {

    @ApiOperation(value = "", nickname = "getDebCredStatus", notes = "", response = Double.class, tags={ "transactions", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/deb_cred_status",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Double> getDebCredStatus(@ApiParam(value = "" ) @RequestHeader(value="Auth", required=false) String auth
);
